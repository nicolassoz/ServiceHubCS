...
namespace ServiceHubClass
{
    public class Produto
    {
        ...
        public Produto(string? codBarras, string? descricao, double vaolorUnit, string? unidadeVenda, Categoria? categoria, double estoqueMinimo, double classeDesconto)
        {
            CodBarras = codBarras;
            Descricao = descricao;
            ValorUnit = vaolorUnit;
        ...
        public Produto(int id, string? codBarras, string? descricao, double vaolorUnit, string? unidadeVenda, Categoria? categoria, double estoqueMinimo, double classeDesconto)
        {
            Id = id;
            CodBarras = codBarras;
            Descricao = descricao;
        ...
        public Produto(int id, string? codBarras, string? descricao, double vaolorUnit, string? unidadeVenda, Categoria? categoria, double estoqueMinimo, double classeDesconto, byte[] imagem, DateTime dataCad, bool descontinuado)
        {
            Id = id;
            CodBarras = codBarras;
            Descricao = descricao;
